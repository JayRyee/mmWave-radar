...
for frame_index = 1:length(fHist)
    % Get a list of all the indexes present in this frame
    ...
    for i = 1:length(index_set)
        ...
        %indx = find(fHist(frame_index).indexArray == current_index);
...
w = load('S1_Data.mat'); % in this data target 0 is human but target 3 is not...
